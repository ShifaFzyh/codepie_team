...
export default function Login() {
  ...
  const handleLoginSubmit = (e) => {
    e.preventDefault();
    // Setelah login sukses, arahkan ke LandingPage (rute "/")
    navigate("/");
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              <label
                htmlFor="email"
                style={{ fontSize: "14px", fontWeight: 600, color: "#45464d", padding: "0 4px" }}
              >
                Email
              </label>
              <div
              ...
              >
                <span className="material-symbols-outlined" style={{ color: "#45464d", marginRight: "12px" }}>
                  mail
                </span>
                <input
                  id="email"
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <a
                  ...
                  style={{ fontSize: "12px", fontWeight: 500, color: "#0058be", textDecoration: "none" }}
                >
                  Forgot Password?
                </a>
              </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px", padding: "0 4px" }}>
              <input
                id="remember"
                type="checkbox"
                style={{ width: "16px", height: "16px", accentColor: "#0058be" }}
              />
              <label
                htmlFor="remember"
                style={{ fontSize: "14px", fontWeight: 600, color: "#45464d" }}
              >
                Remember me
              </label>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              >
                <img
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBT3Z3hRAcYlythCf9cE_ktpzNGO3O5AIfjvTE6P-8ZHLtyjT_8ceAvOHxNmUKI_ynpgpks4Ejlzg0Go05nA2AwaEMPGOZgbbXOpXzYan8AxY3AgC6hMzR31fNTsG6D8w3MPii50VHceDHDYwZDVFV9c6gm7eV_JClbuoIx94kP14jOd1q-dA6_-Now0hrd93_NhyPtmvJwldnyf5ifUygkBvWIRCtdPNqxzvs7CR21-rRPrbQSkeQTeUTGiX6OSvm0_oAf39K_bpw"
                />
              ...
              >
                <span
                  className="material-symbols-outlined"
                  style={{ color: "#191c1e", fontSize: "20px", fontVariationSettings: "'FILL' 1" }}
                >
                  ios
                </span>
                <span style={{ fontSize: "14px", fontWeight: 600, color: "#191c1e" }}>
          ...
          >
            <p style={{ fontSize: "16px", color: "#45464d" }}>
              ...
              <button 
                type="button"
                onClick={() => navigate("/register")} // Mengarahkan navigasi ke rute /register
        ...
        {/* Mobile Bottom Navigation (Hanya muncul di HP/md-hidden) */}
        <footer
          className="md:hidden" 
          style={{
            position: "fixed",
            ...
            boxShadow: "0 -4px 12px rgba(19,27,46,0.04)",
